...
- **设备名称**：10Gbit/s 无源光网络用户端设备（X-GPON ONU）
...
![Telnet 开启成功提示](assets/CMCCAdmin-246aada8.png)
...
> 提示：没有 Telnet 的，在控制面板 > 程序 > 启用或关闭 Windows 功能 > 启用“Telnet Client”

按照提示输入用户名：`CMCCAdmin`，密码：`aDm8H%MdA`

![Telnet 登录提示](assets/CMCCAdmin-3069e7f1.png)

> 输入密码不会显示出来，这里可以通过直接右键 CMD 进行粘贴。
...
![查询 DevAuthInfo 信息](assets/CMCCAdmin-268fa8ea.png)
...
![保存配置](assets/CMCCAdmin-32aebd9c.png)
